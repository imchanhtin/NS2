...
set file2 [open outTest20.nam w]
...
proc finish {} {
        ...
        close $file1
        close $file2
        exec nam outTest20.nam &
	exec awk -f test.awk outTest20.tr &
	exec awk -f rotgoi.awk outTest20.tr > rotgoi20.xg &
	exec xgraph rotgoi20.xg -geometry 800X600 &
        exit 0
}
...
#Tao ket noi
$ns duplex-link $n0 $n3 0.1Mb 45ms DropTail
$ns duplex-link-op $n0 $n3 color red
$ns duplex-link-op $n0 $n3 orient right-down

$ns duplex-link $n1 $n3 0.1Mb 45ms DropTail
$ns duplex-link-op $n1 $n3 color yellow
$ns duplex-link-op $n1 $n3 orient right-up
 
$ns duplex-link $n2 $n3 0.1Mb 45ms DropTail
$ns duplex-link-op $n2 $n3 color brown
$ns duplex-link-op $n2 $n3 orient right

$ns duplex-link $n3 $n4 0.1Mb 45ms DropTail
