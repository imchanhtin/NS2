...
proc finish {} {
	...
	exec awk -f test.awk outTest.tr &
	exec awk -f rotgoi.awk outTest.tr > rotgoi10.xg &
	exec xgraph rotgoi10.xg -geometry 800X600 &
        exit 0
}
